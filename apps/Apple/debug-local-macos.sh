...
PID_FILE="${TMPDIR:-/tmp}/tabminal-mobile-macos-debug.pid"
LOG_FILE="${TMPDIR:-/tmp}/tabminal-mobile-macos-debug.log"
SCREENSHOT_FILE="${TMPDIR:-/tmp}/tabminal-mobile-macos-debug.png"
